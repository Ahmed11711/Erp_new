...
use App\Http\Controllers\Inventory\OperatingSuppliesIssueController;
...
// صور قائمة الأسعار: عامة (الملفات أصلاً في public/images) مع CORS للطباعة/PDF
Route::get('price-list/photo/{filename}', [App\Http\Controllers\PriceListController::class, 'servePhoto'])
    ->where('filename', '[A-Za-z0-9._-]+');

Route::middleware('auth')->group(function () {
    Route::get('system-lock', [App\Http\Controllers\SystemLockController::class, 'status']);
    Route::put('system-lock', [App\Http\Controllers\SystemLockController::class, 'update']);
    Route::get('system-lock/users', [App\Http\Controllers\SystemLockController::class, 'users']);
    Route::get('system-lock/orders-preview', [App\Http\Controllers\SystemLockController::class, 'ordersPreview']);
    ...
    Route::get('conversations/{conversation_id}/orders', [App\Http\Controllers\ConversationController::class, 'orders'])
        ->whereNumber('conversation_id');
    ...
    Route::prefix('whatsapp/')->group(function () {
        ...
        Route::post('customers/archive-all', [App\Http\Controllers\WhatsAppMessageController::class, 'archiveAllCustomers']);
        Route::patch('customers/{customerId}/archive', [App\Http\Controllers\WhatsAppMessageController::class, 'setCustomerArchive'])
    ...
    Route::get('orders/sales-movement', [OrdersController::class, 'salesMovement'])
        ->middleware('permission:orders.view|system.rbac');
    Route::post('orders/sales-movement/missing-invoices/preview', [\App\Http\Controllers\MissingSalesInvoiceJournalController::class, 'preview'])
        ->middleware('permission:orders.view|system.rbac');
    Route::post('orders/sales-movement/missing-invoices/run', [\App\Http\Controllers\MissingSalesInvoiceJournalController::class, 'run'])
        ->middleware('permission:orders.view|system.rbac');
    Route::get('orders/{id}/missing-invoice/preview', [\App\Http\Controllers\MissingSalesInvoiceJournalController::class, 'previewOrder'])
        ->middleware('permission:orders.view|system.rbac')
        ->whereNumber('id');
    Route::post('orders/{id}/missing-invoice/post', [\App\Http\Controllers\MissingSalesInvoiceJournalController::class, 'postOrder'])
        ->middleware('permission:orders.view|system.rbac')
        ->whereNumber('id');
    ...
    Route::get('orders/{id}', [OrdersController::class, 'show'])
        ->whereNumber('id');
    Route::get('orders/{id}/accounting-cycle', [OrdersController::class, 'accountingCycle'])
        ->whereNumber('id');
    ...
    Route::get('reports/categoriesStatusReports', [App\Http\Controllers\CategoriesController::class, 'categoriesStatusReports']);
    ...
    Route::middleware(['permission:nav.shipping.accounts_report|system.rbac'])->group(function () {
        ...
        Route::get('reports/shipping-accounts/{id}/in-hand', [App\Http\Controllers\ShippingAccountingReportController::class, 'inHandInventory']);
    ...
    Route::middleware([FinanceOperationsLegacyApiAccess::class])->group(function () {
        ...
        Route::get('inventory/operating-supplies/ensure', [OperatingSuppliesIssueController::class, 'ensure']);
        Route::post('inventory/operating-supplies/issue', [OperatingSuppliesIssueController::class, 'issue']);
    ...
    Route::middleware([CategoriesApiAccess::class])->group(function () {
        ...
        Route::get('categories/next-item-code', [CategoriesController::class, 'nextItemCode']);
        ...
        Route::post('categories/assign-item-codes-preview', [CategoriesController::class, 'previewAssignItemCodes']);
        Route::post('categories/assign-item-codes', [CategoriesController::class, 'assignItemCodes']);
    ...
    Route::middleware([ManufacturingModuleApiAccess::class])->group(function () {
        ...
        Route::get('manufacture/additions', [App\Http\Controllers\ManufactureAdditionController::class, 'index']);
        Route::post('manufacture/additions', [App\Http\Controllers\ManufactureAdditionController::class, 'store']);
        Route::put('manufacture/additions/{id}', [App\Http\Controllers\ManufactureAdditionController::class, 'update'])->whereNumber('id');
        Route::delete('manufacture/additions/{id}', [App\Http\Controllers\ManufactureAdditionController::class, 'destroy'])->whereNumber('id');
    ...
    Route::middleware([\App\Http\Middleware\ProcessingModuleApiAccess::class])->prefix('processing')->group(function () {
        ...
        // «مخزن التجهيز» — أرصدة المواد المصروفة للمعالجين الخارجيين
        Route::get('warehouse/overview', [\App\Http\Controllers\Processing\ProcessingWarehouseController::class, 'overview']);
        Route::get('warehouse/balances', [\App\Http\Controllers\Processing\ProcessingWarehouseController::class, 'balances']);
        Route::get('warehouse/movements', [\App\Http\Controllers\Processing\ProcessingWarehouseController::class, 'movements']);
        Route::get('warehouse/filters', [\App\Http\Controllers\Processing\ProcessingWarehouseController::class, 'filterOptions']);
    ...
    Route::middleware(['department.access:Admin'])->group(function () {
        ...
        Route::post('users/{id}/change-password', [App\Http\Controllers\UserController::class, 'changePassword']);
    ...
    Route::middleware([EmployeesHrApiAccess::class])->group(function () {
        ...
        Route::post('empHoursPermission/revert', [App\Http\Controllers\EmployeeController::class, 'revertAbsenceDayPermission']);
        ...
        Route::post('registerAttendance', [App\Http\Controllers\EmployeeFingerPrintSheetController::class, 'registerAttendance']);
        ...
        Route::post('payroll/accrual-import/preview', [App\Http\Controllers\PayrollAccrualImportController::class, 'preview']);
        Route::post('payroll/accrual-import/apply', [App\Http\Controllers\PayrollAccrualImportController::class, 'apply']);
    ...
    Route::middleware(['order.profile:offer_crud'])->group(function () {
        ...
        Route::post('offer/{id}/sync-converted-order', [App\Http\Controllers\OffersController::class, 'syncConvertedOrder']);
        Route::post('offer/{id}/link-lead', [App\Http\Controllers\OffersController::class, 'linkLead']);
        Route::apiResource('offer', App\Http\Controllers\OffersController::class);
    });

    Route::middleware(['permission:nav.price_list|price_list.edit|price_list.delete|system.rbac'])->group(function () {
        Route::get('price-list', [App\Http\Controllers\PriceListController::class, 'index']);
        Route::post('price-list', [App\Http\Controllers\PriceListController::class, 'storeList']);
        Route::get('price-list/shopify-products', [App\Http\Controllers\PriceListController::class, 'searchShopifyProducts']);
        Route::get('price-list/shopify-images', [App\Http\Controllers\PriceListController::class, 'shopifyImageCatalog']);
        Route::get('price-list/{listId}', [App\Http\Controllers\PriceListController::class, 'show']);
        Route::post('price-list/{listId}', [App\Http\Controllers\PriceListController::class, 'updateList']);
        Route::delete('price-list/{listId}', [App\Http\Controllers\PriceListController::class, 'destroyList']);
        Route::post('price-list/{listId}/items', [App\Http\Controllers\PriceListController::class, 'storeItem']);
        Route::post('price-list/{listId}/items/from-shopify', [App\Http\Controllers\PriceListController::class, 'importFromShopify']);
        Route::post('price-list/{listId}/items/{itemId}', [App\Http\Controllers\PriceListController::class, 'updateItem']);
        Route::delete('price-list/{listId}/items/{itemId}', [App\Http\Controllers\PriceListController::class, 'destroyItem']);
    });
...
Route::prefix('accounting/')->middleware('auth')->group(function () {
    ...
    Route::prefix('reports/')->group(function () {
        ...
        Route::post('/trial-balance/import-preview', [App\Http\Controllers\V2\Accounting\TrialBalanceOpeningImportController::class, 'preview']);
        Route::post('/trial-balance/import-create-account', [App\Http\Controllers\V2\Accounting\TrialBalanceOpeningImportController::class, 'createMissingAccount']);
        Route::post('/trial-balance/import-apply', [App\Http\Controllers\V2\Accounting\TrialBalanceOpeningImportController::class, 'apply']);
