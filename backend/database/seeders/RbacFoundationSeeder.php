...
class RbacFoundationSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $definitions = [
            ...
            ['module' => 'system', 'slug' => 'system.lock', 'name' => 'Lock the system for other users'],
            ['module' => 'system', 'slug' => 'system.unlock', 'name' => 'Unlock / restart the system'],
            ['module' => 'system', 'slug' => 'system.lock_bypass', 'name' => 'Bypass system lock'],
            ...
            ['module' => 'categories', 'slug' => 'categories.assign_item_codes', 'name' => 'Assign sequential item codes in bulk'],
            ...
            ['module' => 'offers', 'slug' => 'offers.edit', 'name' => 'Edit price offer items'],
            ['module' => 'offers', 'slug' => 'offers.delete', 'name' => 'Delete price offers'],
            ['module' => 'nav', 'slug' => 'nav.price_list', 'name' => 'Nav: Price list'],
            ['module' => 'price_list', 'slug' => 'price_list.edit', 'name' => 'Edit price list items'],
            ['module' => 'price_list', 'slug' => 'price_list.delete', 'name' => 'Delete price list items'],
        ...
        $presetSlugs = [
            ...
            'settings.view', 'system.rbac', 'system.lock', 'system.unlock', 'system.activity_log', 'system.activity_log.edit',
            'categories.view', 'categories.manage', 'categories.assign_item_codes',
            ...
            'offers.edit', 'offers.delete', 'offers.view_all',
            'nav.price_list', 'price_list.edit', 'price_list.delete',
