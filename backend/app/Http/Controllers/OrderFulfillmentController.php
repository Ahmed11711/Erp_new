    ...
    public function show(int $id)
    {
        ...
        if ($order->order_details) {
            try {
                ...
                Log::warning('Fulfillment show: syncFromOrder skipped', [
                    'order_id' => $id,
                    'error' => $e->getMessage(),
                ]);
            }
        ...
        try {
            ...
            Log::warning('Fulfillment show: resolve holder skipped', [
                'order_id' => $id,
                'error' => $e->getMessage(),
            ]);
        }
        ...
        $mixedSplit = $this->liabilityTransfer->mixedOnlineCashSplit($order, $od);
        ...
        return response()->json([
            ...
            'delivery' => [
                ...
                'cash_receivable_amount' => $mixedSplit['cash_amount'] ?? null,
            ],
            'collection' => [
                ...
                'amount_to_collect' => $mixedSplit
                    ? $mixedSplit['online_amount']
                    : $od?->amount_to_collect,
            ...
            'financial' => [
                ...
                'collection_receivable_amount' => $od?->collection_receivable_amount,
                'shipping_receivable_amount' => $od?->shipping_receivable_amount,
                ...
                'liability_transfer_amount' => $mixedSplit
                    ? $mixedSplit['cash_amount']
                    : $this->liabilityTransfer->resolveTransferAmount($order, $od),
