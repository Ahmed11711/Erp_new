...
class ShopifyOrderImportServicePhoneTest extends TestCase
{
    ...
    public function test_resolve_phone_prefers_shipping_over_conflicting_note_attributes(): void
    {
        // حالة طلب #58029: note_attributes قد تحمل رقمًا مختلفًا عن هاتف عنوان الشحن
        $phone = $this->resolvePhone([
            'shipping_address' => ['phone' => '+20 10 01866665'],
            'customer' => ['phone' => '+20 10 01896965'],
            'note_attributes' => [
                ['name' => 'Phone', 'value' => '01001896965'],
            ],
        ], ['phone' => '+20 10 01866665']);

        $this->assertSame('01001866665', $phone);
    }

    public function test_normalize_phone_handles_shopify_ui_spaced_egypt_format(): void
    {
        // صيغة واجهة شوبيفاي: +20 10 01866665
        $this->assertSame('01001866665', $this->normalizePhone('+20 10 01866665'));
        $this->assertSame('01001866665', $this->normalizePhone('+201001866665'));
    }
    ...
    public function test_resolve_phone_prefers_valid_egypt_mobile_over_weak_earlier_candidate(): void
    {
        // رقم ضعيف لكنه usable (طول >= 9) يجب ألا يغلب موبايل مصري صحيح لاحق
        $phone = $this->resolvePhone([
            'shipping_address' => ['phone' => '123456789'],
            'customer' => ['phone' => '+20 10 01866665'],
        ]);
