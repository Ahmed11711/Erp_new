...
export const RBAC_PERMISSION_AR: Record<string, string> = {
  ...
  'system.lock': 'قفل النظام عن المستخدمين',
  'system.unlock': 'إعادة تشغيل النظام بعد القفل',
  'system.lock_bypass': 'العمل أثناء قفل النظام (بدون زر القفل)',
  ...
  'categories.assign_item_codes': 'توليد أكواد الأصناف دفعة واحدة',
  ...
  'offers.edit': 'تعديل عروض الأسعار وحذف أصنافها',
  'offers.delete': 'حذف عروض الأسعار',
  'nav.price_list': 'قائمة: Price List (كتالوج)',
  'price_list.edit': 'إضافة وتعديل منتجات Price List',
  'price_list.delete': 'حذف منتجات Price List',
