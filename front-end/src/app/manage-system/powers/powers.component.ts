...
import { rbacPermissionLabelAr } from '../roles-management/rbac-display-labels';
...
export class PowersComponent implements OnInit {
  ...
  permissionLabel(row: MatrixRow): string {
    return rbacPermissionLabelAr(row.slug || '', row.name || '');
  }
