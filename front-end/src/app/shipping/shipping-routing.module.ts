...
const cs = [...RBAC_ROUTE.ordersChangeStatus];
...
const routes: Routes = [
  ...
  {
    path: 'sales-movement',
    component: SalesMovementComponent,
    canActivate: [departmentGuard],
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./shipping-company-lines/shipping-company-lines.module').then((m) => m.ShippingCompanyLinesModule),
  },
  {
