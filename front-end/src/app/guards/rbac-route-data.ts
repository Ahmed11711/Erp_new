...
export const RBAC_ROUTE = {
  ...
  ordersConvertFromOffer: ['orders.convert_from_offer', 'nav.corporate', 'system.rbac'],
  ordersView: ['orders.view'],
  ordersEdit: ['orders.edit'],
  /** تأكيد الطلب وتغيير الحالة */
  ...
  receiptsQuotes: ['nav.receipts.quotes', 'orders.view', 'nav.corporate', 'system.rbac'],
  /** قائمة أسعار المنتجات (كتالوج الصور) */
  priceList: ['nav.price_list', 'price_list.edit', 'price_list.delete', 'system.rbac'],
  systemAdmin: ['system.rbac'],
  systemLock: ['system.lock'],
  systemUnlock: ['system.unlock'],
  ...
  /** إضافة إضافي/خصم وإدارة كشف الحضور */
  hrManageSheet: [
    'employees.create',
    'employees.edit',
