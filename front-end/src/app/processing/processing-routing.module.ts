...
import { ProcessingWarehouseComponent } from './processing-warehouse/processing-warehouse.component';
...
const routes: Routes = [
  ...
  { path: 'warehouse', component: ProcessingWarehouseComponent, canActivate: [departmentGuard], data: { rbacPermissions: perms } },
