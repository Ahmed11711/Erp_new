...
export class ProcessingService {
  ...
  warehouseOverview(params: any = {}) {
    return this.http.get<any>(`${this.base}/warehouse/overview`, { params });
  }

  warehouseMovements(params: any = {}) {
    return this.http.get<any[]>(`${this.base}/warehouse/movements`, { params });
  }

  warehouseFilters() {
    return this.http.get<any>(`${this.base}/warehouse/filters`);
  }
}
